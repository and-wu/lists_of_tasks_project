...
async def NOT_send_list_reminder(bot: Bot, user_id: int, list_id: int, service: UserService) -> None:
...
async def send_list_reminder(bot: Bot, user_id: int, list_id: int, service) -> None:
...
class ReminderScheduler:
    def __init__(self, scheduler: AsyncIOScheduler, bot: Bot, service: UserService) -> None:
        self.scheduler = scheduler
        self.bot = bot
        self.service = service

    def schedule_list_reminder(self, user_id: int, list_id: int, remind_time: time) -> None:
